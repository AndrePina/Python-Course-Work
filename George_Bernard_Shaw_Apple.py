...
def exchange_apples(you, me):
    ...
    tempJohanna = johanna.apples
    tempMartin = martin.apples
    # print(tempJohanna)
    # print(tempMartin)
    you.apples = tempMartin
    me.apples = tempJohanna
    # print(you.apples)
    # print(me.apples)
...
def exchange_ideas(you, me):
    ...
    # print(martin.ideas)
    sharedIdeas = johanna.ideas + martin.ideas
    you.ideas = sharedIdeas
    me.ideas = sharedIdeas
    # print(me.ideas)
